...
//
//    private final static LexiconDatabase instance = new LexiconDatabase();
//
...
//    }
//
//    public static void connect(String dbStr) {
//        instance.sqlite = SQLite.connect(dbStr);
//    }
//
//    public void close() {
//        sqlite.close();
...
//        return sqlite.updateItem(data);
//    }
//
//    public boolean updateItems(EntryContent animal, EntryContent wolf, EntryContent elephant, EntryContent cat, EntryContent lion, EntryContent feline) {
//  return sqlite.updateItems()
//    }
//}
//
////    @Override
////    protected String[] tableDeclarations() {
////        return new String[]{CREATE_ENTRIES_TABLE, CREATE_LINKS_TABLE};
////    }
////
////    @Override
////    protected Collection<PreparedStatement> prepareStatements(Connection conn) throws SQLException {
////        List<PreparedStatement> statements = new ArrayList<>(setEntryStatements(conn));
////        statements.addAll(setLinkStatements(conn));
////        return statements;
////    }
////
...
////
////    private Collection<PreparedStatement> setEntryStatements(Connection conn) throws SQLException {
...
////        return Arrays.asList(insertContentStatement, queryStatement, queryAllStatement, removeEntryStatement, updateEntryStatement);
////    }
////
...
////
////    private Collection<PreparedStatement> setLinkStatements(Connection conn) throws SQLException {
...
////        return Arrays.asList(insertLinkStatement, queryLinksStatement, removeLinkStatement);
////    }
////
